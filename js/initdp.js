  ...
  if (!globalPlayer) {
    globalPlayer = new APlayer({
      ...
      audio: [{name: '沙丁鱼从地里钻了出来',artist: 'UTAU',url: '/music/【UTAU】沙丁鱼从地里钻了出来.mp3',cover:defcover},
        ...
        {name: '不是临江仙也不是西江月',artist: '洛天依',url: '/music/不是临江仙也不是西江月-洛天依.mp3',cover:defcover},
        {name: '柑橘',artist: '初音ミク',url: '/music/柑橘-初音ミク.mp3',cover:defcover},
        {name: '错位时空',artist: '洛天依&乐正绫',url: '/music/错位时空-洛天依&乐正绫.mp3',cover:defcover},
        {name: '花信予时',artist: '乐正绫',url: '/music/花信予时-乐正绫.mp3',cover:defcover},
        {name: '莫问归期',artist: '洛天依',url: '/music/莫问归期-洛天依.mp3',cover:defcover},
        {name: '难却',artist: '乐正绫',url: '/music/难却-乐正绫.mp3',cover:defcover},
        {name: '难却',artist: '洛天依',url: '/music/难却-洛天依.mp3',cover:defcover},
        {name: '青鸟衔风',artist: '洛天依&乐正绫',url: '/music/青鸟衔风-洛天依&乐正绫.mp3',cover:defcover},
        {name: '如果只转身后退就能回到那个夏天',artist: '星尘',url: '/music/如果只转身后退就能回到那个夏天-星尘.mp3',cover:defcover},
        {name: '天亮以前说再见',artist: '星尘',url: '/music/天亮以前说再见-星尘.mp3',cover:defcover},
        {name: '望穿秋水',artist: '洛天依&乐正绫',url: '/music/望穿秋水-洛天依&乐正绫.mp3',cover:defcover},
        {name: '燕无歇',artist: '星尘',url: '/music/燕无歇-星尘.mp3',cover:defcover},
        {name: '知否知否',artist: '洛天依',url: '/music/知否知否-洛天依.mp3',cover:defcover},
        {name: '爱情讯息',artist: '洛天依',url: '/music/爱情讯息-洛天依.mp3',cover:defcover},
        {name: '不堪人间',artist: '洛天依',url: '/music/不堪人间-洛天依.mp3',cover:defcover},
        {name: '关山酒',artist: '乐正绫',url: '/music/关山酒-乐正绫.mp3',cover:defcover},
        {name: '世末歌者(v)',artist: '乐正绫',url: '/music/世末歌者v-乐正绫.mp3',cover:defcover},
        {name: '霜雪千年',artist: '洛天依&乐正绫',url: '/music/霜雪千年-洛天依x乐正绫.mp3',cover:defcover},
        {name: '西楼别序',artist: '洛天依',url: '/music/西楼别序p-洛天依.mp3',cover:defcover},
        {name: '酔恋花',artist: '洛天依',url: '/music/酔恋花-洛天依.mp3',cover:defcover},
        {name: '等待暴雨过后',artist: '星尘',url: '/music/等待暴雨过后-星尘.mp3',cover:defcover},
        {name: '隔世雪',artist: '洛天依&乐正绫',url: '/music/隔世雪-洛天依&乐正绫.mp3',cover:defcover},
        {name: '寒叶霜',artist: '洛天依&乐正绫',url: '/music/寒叶霜-洛天依&乐正绫.mp3',cover:defcover},
        {name: '浣花邻韵',artist: '洛天依&乐正绫',url: '/music/浣花邻韵-洛天依&乐正绫.mp3',cover:defcover},
        {name: '千盏',artist: '星尘',url: '/music/千盏-星尘.mp3',cover:defcover},
        {name: '铁花飞',artist: '乐正绫',url: '/music/铁花飞-乐正绫.mp3',cover:defcover},
        {name: '炜WardRomance',artist: '星尘',url: '/music/炜WardRomance-星尘infinity.mp3',cover:defcover},
        {name: '游春',artist: '洛天依',url: '/music/游春-洛天依.mp3',cover:defcover},
        {name: '咏春',artist: '星尘',url: '/music/咏春-星尘.mp3',cover:defcover},
